...
import static com.example.doctorstrangedemo.ListaMovimiento.*;
import static com.example.doctorstrangedemo.ListaSuperheroes.*;
import static com.example.doctorstrangedemo.ListaSuperheroes.captainmarvel;
...
public class Superheroe {
    ...
    private int coste, recompensa,energiaInicial=80;
    private Double energiaVital, energiaLucha;
    ...
    public void setDatos(String identidadSecreta, String origen, String afiliacion, List<Integer> list,
        ...
        int monedas = escenario.escenarioAtributosList.get(0);
        int miembros = escenario.escenarioAtributosList.get(1);
        Double energiaVital = (double)escenario.escenarioAtributosList.get(3);
        ...
        this.energiaLucha = (double)escenario.getEscenarioAtributosList().get(2)*150;
    }
